...
for random_state in range(20):
    ...
    if 0 == stabilize:
        ...
        est = Symbolic_Reg_ST( population_size=200,
                               generations=100,
                               tournament_size=5,
                               num_elite_select = 1,
                               max_depth=4,
...
print("test all results: rmse, r2")
_test_res = []
for val in res_vals:
    y_test_pred = val[2].predict(X_test)
    _test_res.append((mean_squared_error(y_true=y_test, y_pred=y_test_pred, squared=False), r2_score(y_true=y_test, y_pred=y_test_pred)))
print(_test_res)
